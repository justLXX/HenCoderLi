...
public class NestedParentRecyclerView extends RecyclerView implements NestedScrollingParent2 {
    ...
    public NestedParentRecyclerView(@NonNull Context context) {
        super(context);
        init();
        View recyclerView = new EventRecyclerView(context);
    }
    ...
    public NestedParentRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        addOnItemTouchListener(new SwipeItemTouchListener());
    }
